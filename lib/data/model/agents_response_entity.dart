...
class AgentsResponseEntity {
	...
	factory AgentsResponseEntity.fromJson(Map<String, dynamic> json) => $AgentsResponseEntityFromJson(json);
...
class AgentsResponseData {
	...
	factory AgentsResponseData.fromJson(Map<String, dynamic> json) => $AgentsResponseDataFromJson(json);
...
class AgentsResponseDataRole {
	...
	factory AgentsResponseDataRole.fromJson(Map<String, dynamic> json) => $AgentsResponseDataRoleFromJson(json);
...
class AgentsResponseDataAbilities {
	...
	factory AgentsResponseDataAbilities.fromJson(Map<String, dynamic> json) => $AgentsResponseDataAbilitiesFromJson(json);
...
class AgentsResponseDataVoiceLine {
	...
	factory AgentsResponseDataVoiceLine.fromJson(Map<String, dynamic> json) => $AgentsResponseDataVoiceLineFromJson(json);
...
class AgentsResponseDataVoiceLineMediaList {
	...
	factory AgentsResponseDataVoiceLineMediaList.fromJson(Map<String, dynamic> json) => $AgentsResponseDataVoiceLineMediaListFromJson(json);

	Map<String, dynamic> toJson() => $AgentsResponseDataVoiceLineMediaListToJson(this);
